  ...
  return (
    <div ref={containerRef} className="z-50 w-[371px] flex flex-col items-end">
      ...
      >
        ...
        >
          <h4 className="font-body text-[22px] text-[#FDFDFD] tracking-widest relative" style={{ right: "30px" }}>
            INDEX
          </h4>
        </div>
      </div>
      ...
      {open ? (
        ...
        >
          <span className="font-body text-[15px] text-[#dadada]">Click to expand</span>

    ...
    <>
      <section className="max-w-[1400px] mx-auto px-8 pb-32">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="hidden md:block shrink-0 w-[271px]">
